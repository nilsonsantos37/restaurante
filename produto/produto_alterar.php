...
<div class="container">
    ...
    <?php 
     ...
     $usuario = $usuario_control -> seleciona($cod_usuario); 
        ...
        $produto = $produto_control -> selecionar($cod_prod);       
        ?>
      <form action="alterar_produto.php" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                 ...
                 <textarea class="form_control" name="info_produto" id="info_produto" rows="4" cols="50"><?= $produtos[0]['info_adicional']; ?></textarea>
            </div>
